...
1. For each spec, write or replace the `## Review` section at the bottom of the file. This section is your review notes for the next interactive session. Cover what a holistic read reveals — issues within the spec, contradictions with other specs, gaps, staleness, what's solid. Most important things first.
